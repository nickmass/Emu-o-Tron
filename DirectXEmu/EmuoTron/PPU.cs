...
namespace EmuoTron
{
    ...
    public class PPU
    {
                ...
                if (scanline < 240 && (backgroundRendering || spriteRendering))
                {
                    ...
                    if (scanlineCycle < 256 || (scanlineCycle >= 320 && scanlineCycle < 336))
                    {
                        ...
                        else if (shiftCount == 2)
                        {
                            ...
                            paletteLatcher = (PPURead(((tileAddress & 0x3C00) + 0x3C0) + (addrTableLookup & 0x3F), AccessType.attrTable) >> ((addrTableLookup >> 5) & 6)) & 0x3;
                        }
            ...
            for (int nameTable = 0; nameTable < 4; nameTable++)
            {
                ...
                for (int line = 0; line < 240; line++)
                {
                    ...
                    for (int tile = 0; tile < 32; tile++)//each tile on line
                    {
                        ...
                        int palette = (PPUMemory[((tileAddr & 0x3C00) + 0x3C0) + (addrTableLookup & 0x3F)] >> ((addrTableLookup >> 5) & 6)) & 0x03;
        ...
        private readonly int[] vertFlipTable = { 7, 5, 3, 1, -1, -3, -5, -7};

        private readonly byte[] AttrTableLookup =
            {
                
            };
