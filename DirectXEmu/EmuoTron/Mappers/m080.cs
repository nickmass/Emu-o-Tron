    ...
    class m080 : Mapper
    {
        ...
        public override void Write(byte value, ushort address)
        {
            if (address >= 0x7EF0 && address < 0x7F00)
            {
                ...
                {
                    case 0x7EF0:
                        nes.PPU.PPUMemory.Swap1kROM(0x0000, value & 0xFE);
                        nes.PPU.PPUMemory.Swap1kROM(0x0400, (value & 0xFE) | 1);
                        break;
                    case 0x7EF1:
                        nes.PPU.PPUMemory.Swap1kROM(0x0800, value & 0xFE);
                        nes.PPU.PPUMemory.Swap1kROM(0x0C00, (value & 0xFE) | 1);
                        break;
                    case 0x7EF2:
